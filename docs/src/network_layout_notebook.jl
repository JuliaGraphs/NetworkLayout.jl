...
# ╔═╡ 365741b0-0d69-11ef-1bc8-6f669c41fcc4
begin
	using CairoMakie
	using NetworkLayout
...
# ╔═╡ 0199dbd5-5e0d-4647-917b-a81b15a7d175
begin
	ticks_per_sec = 20
	@bind ticks Clock(1 / ticks_per_sec, true)
end

# ╔═╡ 1b605074-0b50-4bb0-8dfc-1a5cd9889619
md"""# Define graph and layout"""

# ╔═╡ 70a7cc7e-81c1-4a8a-8acc-cd47655a6cad
md"""N: $(@bind N PlutoUI.Slider(3:30, default=10, show_value=true))"""

# ╔═╡ c913a75c-436e-4bbc-9e6a-68f1d8f9bddf
begin
	g = wheel_graph(N)
...
# ╔═╡ 0c667ddf-8b7e-4711-a61e-9eb91a032401
begin
...
# ╔═╡ 5a04664d-8c1c-4b38-b6ad-25c5bec423ca
begin
	ticks
	i, state = it[1]
	_it = iterate(iterator, state)
	if _it !== nothing
		it[1] = _it
		p[:node_pos][] = _it[1]
	end
...
manifest_format = "2.0"
project_hash = "8eff1332ed8d394c45b09c2820bf9af47721e5c3"
...
git-tree-sha1 = "3be245211e1a8d12d4579d4b79f51208a594fc93"
